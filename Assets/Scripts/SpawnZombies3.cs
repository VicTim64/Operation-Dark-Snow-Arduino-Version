...
public class SpawnZombies3 : MonoBehaviour
{
	...
	public int numberOfZombies3 = 5;//How many zombies do we want in our game?
	...
	void Start()
	{
		...
		zombiePrefab = GameObject.FindGameObjectWithTag("Zombie3");
	...
	void Update()
	{
		...
		int nrZombiesExist = GameObject.FindGameObjectsWithTag("Zombie3").Length;
		while (nrZombiesExist < numberOfZombies3)
		{
