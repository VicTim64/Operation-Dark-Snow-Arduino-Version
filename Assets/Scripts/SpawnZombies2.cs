...
public class SpawnZombies2 : MonoBehaviour
{

	public int numberOfZombies2 = 5;//How many zombies do we want in our game?
	...
	void Start()
	{
		...
		zombiePrefab = GameObject.FindGameObjectWithTag("Zombie2");
	...
	void Update()
	{
		...
		int nrZombiesExist = GameObject.FindGameObjectsWithTag("Zombie2").Length;
		while (nrZombiesExist < numberOfZombies2)
		{
